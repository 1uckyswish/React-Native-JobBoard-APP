...
import { Company, JobAbout, JobFooter, Job,Tabs, ScreenHeaderBtn, Specifics, JobTabs} from '../../components';
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.lightWhite }}>
        <Stack.Screen options={{
            ...
            headerLeft: () => (
                <ScreenHeaderBtn iconUrl={icons.left} dimension="80%" handlesPress={()=> router.back()}/>
            ),
             headerRight: () => (
                <ScreenHeaderBtn iconUrl={icons.share} dimension="55%" />
            ),
            headerTitle: ''
        }}/>
        <>
